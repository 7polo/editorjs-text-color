...
Use your package manager to install the package `editorjs-editorjs-text-color`.

```
npm install editorjs-editorjs-text-color

yarn add editorjs-editorjs-text-color
```
